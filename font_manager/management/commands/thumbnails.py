...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if len(options) == 0:
            print "No option given. Read help with ./manage.py help thumbnails"
        else:
            file_list = None
            if not options['sha']:
                ...
                if options["delete"]:
                    ...
                    print "Use --update or --delete with sha option. More infos with ./manage.py help thumbnails"
